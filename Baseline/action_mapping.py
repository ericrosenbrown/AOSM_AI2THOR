...
def importantObject(check_obj,task):
	if task == "cook_egg":
		...
		important_objects = ["Bread","Toaster","Knife","CounterTop"]
...
def make_actionmap(floorPlan='FloorPlan2',task="toast_bread",gridSize=0.25):
	...
	pickle.dump({"action_map":action_map, "room":room}, open("action_maps/new_amap_"+floorPlan+"_"+task+".p", "wb" ) )
